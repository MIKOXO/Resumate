    ...
    <div className="flex h-full flex-col">
      <div className="shrink-0 border-b border-default p-3">
        <button
          ...
          className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-strong py-2 text-sm font-medium text-primary transition-colors hover:border-default hover:bg-surface"
        >
