...
export const outlineBtn = () =>
  cn(
    'inline-flex items-center justify-center gap-2 rounded-lg border border-default px-4 py-2 text-sm font-medium text-primary transition-colors hover:bg-surface',
  )
